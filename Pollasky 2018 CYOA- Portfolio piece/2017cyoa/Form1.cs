...
namespace _2017cyoa
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void btn1_Click(object sender, EventArgs e)
        {
            ...
            if (sentButton.Name == "btn1")
            {
                lblpoints.Text = (int.Parse(lblpoints.Text) - 1).ToString();
            }
            else if (sentButton.Name == "btn2")
            {
               lblpoints.Text = (int.Parse(lblpoints.Text) + 5).ToString();
            }
